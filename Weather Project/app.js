...
app.post("/FavouritesAdded", async(req, res) => {
   ...
   if(savedData[1]) 
   {
    ...
    await WeatherCity.updateOne({city: savedData[0].city}, {city: req.body.city});
        ...
        response.on("data", function(data){
            ...
            https.get(url2, function(response){
                response.on("data", function(data){
                    ...
                    res.render("favourite.ejs", {savedcity1:SavedCityName1, savedcity2:SavedCityName2,savedtemp1:savedtemp1, savedtemp2:savedtemp2,saveddesc1:saveddesc1, saveddesc2:saveddesc2, flag:"true"})
                })
                }) 
        })
    })
...
app.post("/deleteSavedWeathers", async(req, res) => {

    await WeatherCity.deleteMany({});
    res.render("index.ejs");
